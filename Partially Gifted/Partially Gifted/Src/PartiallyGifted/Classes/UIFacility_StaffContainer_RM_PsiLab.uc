...
class UIFacility_StaffContainer_RM_PsiLab extends UIFacilityStaffContainer;
	...
	for (i = 0; i < Facility.StaffSlots.Length; i++)
	{
		...
		else
		{
			...
			case class'UIFacility_PsiLab':
				...
				{
				StaffSlots.AddItem(Spawn(class'UIFacility_RM_PsiVeteranSlot', self).InitStaffSlot(self, LocationRef, i, onStaffUpdatedDelegate));
				}
