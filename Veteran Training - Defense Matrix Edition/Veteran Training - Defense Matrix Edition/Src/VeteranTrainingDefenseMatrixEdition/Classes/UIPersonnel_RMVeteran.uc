//  FILE:    UIPersonnel_RMVeteran
//  AUTHOR:  RealityMachina (using Long War Studio's Officer Pack as a base)
//
//  PURPOSE: Implements custom localization and filtering mechanism for veteran selection
//
//--------------------------------------------------------------------------------------- 

class UIPersonnel_RMVeteran extends UIPersonnel;
...
simulated function UpdateData()
{
	...
	for(i = 0; i < HQState.Crew.Length; i++)
	{
		...
		if(Unit.IsAlive())
		{
			if (Unit.IsASoldier())
			{
				//Check StaffSlot Validation function, defined in RM Veteran StaffSlot Template
